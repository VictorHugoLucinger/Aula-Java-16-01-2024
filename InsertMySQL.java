...
public class InsertMySQL {   
    ...
    Scanner scnSenha = new Scanner(System.in);
        try { 
            ...
            System.out.println("Digite o senha que será cadastrada: ");
            String strSenha = scnSenha.nextLine();
            String strInsertMySQL = "CREATE TABLE `mysql_connector`.`tbl_login` (`login`,`nome`,`senha`) value ('" + strLogin + "','" + strNome + "','" + strSenha + "');";
